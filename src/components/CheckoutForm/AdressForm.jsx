...
const AdressForm = ({checkoutToken, test}) => {
    ...
    return (
        <>
            <Typography variant="h6" gutterButtom>Endereço de entrega</Typography>
            <FormProvider {...methods}>
                ...
                <FormInput required name="firstName" label="Primeiro Nome" />
                    ...
                    <Grid item xs={12} sm={6}>
                        ...
                        <Select value={shippingOption} fullWidth onChange={(e) => setShippingOption(e.targe.value)}>
                        {options.map((option)=> (
                ...
                <div style={{display:'flex', justifyContent: 'space-between'}}>
                    ...
                    <Button type="submit" variant="contained" color="primary">Pagamento</Button>
